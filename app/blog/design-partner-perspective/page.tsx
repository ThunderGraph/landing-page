...
import Image from 'next/image' // Keep Image import even if not used immediately, for consistency or future use

export const metadata = {
  title: 'Enhancing Systems Engineering Workflows with AI: A Design Partner\'s Perspective - ThunderGraph Blog',
  description: 'Insights from a design partner on how ThunderGraph\'s AI automation is transforming systems engineering processes, focusing on requirements, architecture, and human-AI collaboration.',
}
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <article>
              <header className="mb-8">
                ...
                {/* Optional: Add a subtitle/description if desired */}
                {/* <div className="text-xl text-gray-400">Short description here...</div> */}
                <div className="flex items-center mt-4 mb-8">
                  <div className="text-gray-500">
                    {/* TODO: Update publish date */}
                    <span>Published: May 4, 2025</span> 
                  </div>
                </div>
                
                {/* Optional: Featured Image - Add if you have one */}
                {/* <div className="mb-8 rounded-lg overflow-hidden shadow-lg">
                  <Image 
                    src="/images/blog/design-partner-perspective/your-image.png" // Update path
